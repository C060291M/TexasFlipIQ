import type {
  ...
  TexasRegion, FinishLevel, RegionalPricing,
} from '@/types';
...
export const REGIONAL_PRICING: RegionalPricing[] = [
  {
    region: 'austin', regionLabel: 'Austin Metro',
    zipPrefixes: ['787', '786', '788'],
    laborMultiplier: 1.28, materialMultiplier: 1.12,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'other', regionLabel: 'Rio Grande Valley',
    zipPrefixes: ['785'],
    laborMultiplier: 0.90, materialMultiplier: 1.03,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'houston', regionLabel: 'Houston Metro',
    zipPrefixes: ['770', '771', '772', '773', '774', '775', '776', '777'],
    laborMultiplier: 1.15, materialMultiplier: 1.08,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'dfw', regionLabel: 'Dallas Metro',
    zipPrefixes: ['750', '751', '752', '753', '754', '755', '758', '759'],
    laborMultiplier: 1.20, materialMultiplier: 1.10,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'dfw', regionLabel: 'Fort Worth',
    zipPrefixes: ['760', '761', '762'],
    laborMultiplier: 1.18, materialMultiplier: 1.08,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'other', regionLabel: 'Waco',
    zipPrefixes: ['766', '767'],
    laborMultiplier: 1.02, materialMultiplier: 1.02,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'san_antonio', regionLabel: 'San Antonio',
    zipPrefixes: ['782', '783', '784'],
    laborMultiplier: 1.12, materialMultiplier: 1.05,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'other', regionLabel: 'South Texas',
    zipPrefixes: ['780', '781', '789'],
    laborMultiplier: 1.05, materialMultiplier: 1.03,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'east_texas', regionLabel: 'East Texas',
    zipPrefixes: ['716', '717'],
    laborMultiplier: 0.96, materialMultiplier: 1.02,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'east_texas', regionLabel: 'Tyler / Longview',
    zipPrefixes: ['756', '757'],
    laborMultiplier: 0.97, materialMultiplier: 1.02,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'east_texas', regionLabel: 'Beaumont',
    zipPrefixes: ['776', '777'],
    laborMultiplier: 1.05, materialMultiplier: 1.04,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'panhandle', regionLabel: 'Amarillo',
    zipPrefixes: ['790', '791'],
    laborMultiplier: 0.94, materialMultiplier: 1.04,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'other', regionLabel: 'Lubbock',
    zipPrefixes: ['794'],
    laborMultiplier: 0.93, materialMultiplier: 1.03,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'west_texas', regionLabel: 'El Paso',
    zipPrefixes: ['798', '799'],
    laborMultiplier: 0.92, materialMultiplier: 1.05,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
  {
    region: 'west_texas', regionLabel: 'West Texas',
    zipPrefixes: ['792', '793', '795', '796', '797'],
    laborMultiplier: 0.92, materialMultiplier: 1.06,
    lastUpdated: '2025-01-15', dataSource: 'TX Contractors Association',
  },
];

// ── Region lookup — longest prefix wins ──────────────────────
...
const BASE_COSTS: Record<string, BaseCost> = {
  light: {
    kitchen:    { base: 6500 },
    bathrooms:  { base: 3200, perBath: 1800 },
    flooring:   { perSqft: 3.00 },
    roof:       { base: 0, perSqft: 0 },
    hvac:       { base: 0, perSqft: 0 },
    electrical: { base: 1200, perSqft: 0.40 },
    plumbing:   { base: 800, perSqft: 0 },
    paint:      { perSqft: 1.10 },
    foundation: { base: 0 },
...
const STRATEGY_MULTIPLIERS: Record<string, Record<string, number>> = {
  flip: {
    kitchen: 1.30, bathrooms: 1.22, flooring: 1.18,
    roof: 1.00, hvac: 1.00, electrical: 1.00,
    plumbing: 1.00, paint: 1.12, foundation: 1.00,
    landscaping: 1.25, windows: 1.15, doors: 1.20,
  },
  str: {
    kitchen: 1.50, bathrooms: 1.45, flooring: 1.28,
    roof: 1.00, hvac: 1.10, electrical: 1.15,
    plumbing: 1.05, paint: 1.30, foundation: 1.00,
    landscaping: 1.40, windows: 1.20, doors: 1.30,
  },
  ltr: {
    kitchen: 0.80, bathrooms: 0.82, flooring: 0.88,
    roof: 1.00, hvac: 1.00, electrical: 0.95,
    plumbing: 0.95, paint: 0.88, foundation: 1.00,
...
export function calculateRehab(input: PropertyInput): RehabResult {
  ...
  const calc: Record<string, number> = {
    ...
    foundation:
      hasFoundationIssues
        ? (base.foundation.base + 8000) * laborM
        : base.foundation.base * laborM,
    landscaping:
...
export function getBudgetAllocationTargets(
  strategy: string
